              ...
              <div className="card" style={{ borderTop: 0 }}>
                ...
                >
                  ...
                  <input
                    ...
                    defaultValue="0FdGfpmR9u8KQ38SxIsaIesrUdlxore7PvKpxOYCZxEL9M9y7lCJmZVqWsvi6Ak8+V9rFYFJHM2ZvqVGagG4Zg=="
                  />
                  <div className="form-group">
                    <label
                      className="control-label col-md-4 col-xs-2"
                      htmlFor="My_Language"
                    >
                      My language
                    </label>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-xs-6">
                        <span id="helpBlock" className="help-block">
                          Select your language. This also sets the language for
                          all your invoices.
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="form-group">
                    <label className="control-label col-md-4 col-xs-2">
                      My Region &amp; Units
                    </label>
                    <div className="row">
                      <div className="col-md-4 col-xs-4">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-xs-6">
                        <span id="helpBlock" className="help-block">
                          The formats for dates and currencies.
                          <br />
                          25/10/2020 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1,234.50
                        </span>
                      </div>
